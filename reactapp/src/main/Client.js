        ...
        <>
            ...
            >
                ...
                <Box sx={{display:"flex",width:"50%",gap:"50px"}} p={3} >
                    <Button color="secondary" size="small" variant='outlined' sx={{padding:"10px 25px"}} onClick={()=>{setModalOpen(true)}}>Edit Client</Button>
                    <Button color='secondary' size="small" variant='outlined' sx={{padding:"10px 25px"}}  onClick={()=>{setModalOpen(true)}}>Add Client</Button>
                    <Button color='secondary' size="small" variant='outlined' sx={{padding:"10px 25px"}} disabled={selectedRow===null ? false : true} onClick={()=>{del(selectedRow[0]['id'])}}>Delete Client</Button>
                </Box>
